                ...
                <div className='flex md:flex-row flex-col gap-5'>
                  ...
                  <div className='w-full h-screen  bg-white rounded-xl border-2 shadow-xl relative'>
                    ...
                    <div className='flex flex-col gap-2 absolute top-1/2 md:right-4 right-2'>
                      <div className=' rounded-lg w-7 h-7 bg-[#00aee6] flex justify-center items-center shadow shadow-[#00aee6] cursor-pointer' onClick={handle_netSuitSubmission} > <LuPlus /></div>
