  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosBaseURL.post(
        "/api/v1/notification/emails/forgotpassword",
        {
          email: email,
  ...
  return (
    <>
      <div className="bg-[#1B4A68] w-screen h-screen flex items-center justify-center relative z-20">
        <h1 className="absolute top-8 left-12 text-lg text-white flex  z-20">
          Tika{" "}
        ...
        <h1 className="absolute right-4 top-8 md:top-6 text-white text-2xl  z-20 ">
          AB
        ...
        {/* <h1 className="absolute right-4 top-20 md:top-8 text-white text-3xl z-20 ">
          NE
          <span className="w-full h-full relative">
            X{" "}
            <p className="absolute left-1.5 top-0.5 text-2xl text-[#276A8C] z-20">
              X
            </p>
          </span>
          T SCIENCE
          ...
          <div className="w-full mt-3">
            ...
            >
              ...
              <div className="flex gap-5">
                <button
                  className="relative mt-5 self-en rounded-full text-xs px-12 py-1 button-85 bg-white border-2 text-black"
                  onClick={() => navigate("/nsrxmgt")}
                >
                  Back
                </button>
                <button
                  type="submit"
                  className="relative mt-5 self-end rounded-full text-xs px-12 py-1 button-85 bg-white border-2 text-black"
                >
                  Submit
                </button>
              </div>
