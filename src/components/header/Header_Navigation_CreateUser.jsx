...
function Header_Navigation_CreateUser() {
    ...
    <div className="w-full text-xs flex items-center justify-between py-1 font-bold z-50">
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <span
            className="text-white hidden md:block z-50"
            onClick={() => navigate(-1)}
          >
            ABC Co.
          </span>
        ...
        {userData && (
          <span
            className="text-white flex items-center gap-1 z-50"
            onClick={openEditUserProfile}
          >
            <AccountCircle />
            <span
              className="underline cursor-pointer hidden md:block z-50"
              onClick={openEditUserProfile}
            >
      ...
      <div className="item-center text-center">
        <span className="uppercase text-center text-[#FE7D00] text-sm font-bold z-50">
          Create User
        </span>
      </div>
      <div className="flex items-center gap-3">
        ...
        <span
          className="text-white flex items-center z-50 cursor-pointer"
          onClick={fax_handleClick}
        >
          <FaxIcon />
          <span
            className="text-white hidden md:block z-50"
        ...
        >
          <Logout />
          <span className="text-white hidden md:block z-50" onClick={logout}>
            {" "}
            Logout
          </span>
        </span>
...
export default Header_Navigation_CreateUser;
