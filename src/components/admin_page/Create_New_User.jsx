...
const Create_New_User = () => {
  ...
  const createUser = async () => {
    ...
    try {
      await axiosBaseURL
        .post("/api/v1/users/create/user", userData, config, {
  ...
  return (
    <section className=" max-hit-fit flex justify-center  items-center  md:px-0 px-4 ">
      <div className="bg-[#ffffff] shadow-xl border rounded-3xl max-w-fit max-w-[800px] md:max-h-[450px] w-full h-full  mt-5 md:mt-10 overflow-hidden overflow-y-scroll pb-5 no-scrollbar">
        <div className="pt-5 flex justify-center">
          <div className=" border  h-5 rounded-xl w-40 relative">
            <div
              className="bg-orange-500 w-20 h-6 rounded-xl flex justify-center items-center absolute -top-[3px] text-xs cursor-pointer"
        ...
        <form className="">
          <div className=" flex  flex-col xl:items-start md:items-start items-center">
            <div className="px-5 pt-10">
              <div className="flex w-full xl:flex-row md:flex-row flex-col md:gap-5 xl:gap-5 gap-1 justify-between ">
                <div className="flex flex-col">
                  <div className=" flex items-center flex-row w-full g ">
                    <div className=" flex  justify-start  flex-col w-full ">
                      ...
                      <input
                        className="gap-1 bg-[#f2f2f2] rounded-[5px] border border-gray-300 w-56  text-black py-1 text-xs t-1"
                        name="userName"
                        type="text"
                        autoComplete="off"
                ...
                <div className="flex flex-col">
                  <div className=" flex items-center flex-row w-full g ">
                    <div className=" flex  justify-start  flex-col w-full ">
                      ...
                      <input
                        className="bg-[#f2f2f2] rounded-[5px] border border-gray-300 w-56 text-black py-1 text-xs"
                        type="text"
                        autoComplete="off"
                        name="firstName"
                ...
                <div className="flex flex-col">
                  <div className=" flex items-center flex-row w-full g ">
                    <div className=" flex  justify-start  flex-col w-full ">
                      ...
                      <input
                        className="bg-[#f2f2f2] rounded-[5px] border border-gray-300 w-56 text-black py-1 text-xs t-1"
                        name="address"
                        type="text"
                        autoComplete="off"
