...
const Edit_Profile = () => {
  ...
  return (
    <section className=" max-h-fit  flex justify-center item-center  md:px-0 px-4 ">
      <div className="bg-[#ffffff] shadow-xl shadow-lg border rounded-3xl  max-w-fit max-w-[500px] max-h-[1000px] w-full h-full  mt-5 overflow-hidden overflow-y-scroll pb-5 no-scrollbar">
        <div className="pt-5 flex justify-center">
          <div className=" border  h-5 rounded-xl w-40 relative">
            <div className="bg-orange-500 w-40 h-6 rounded-xl flex justify-center items-center absolute -top-[3px] text-xs">
              Edit Profile
            </div>
          </div>
          <ToastContainer />
        ...
        <form className="">
          <div className=" flex  flex-col md:items-start xl:items-start items-center">
                ...
                <div className="flex justify-start flex-col w-full">
                  <div className=" flex items-center flex-col md:flex-row w-full  ">
                    <div className=" flex  justify-start  flex-col w-full ">
                      ...
                      <input
                        className="bg-[#f2f2f2] rounded-2xl border border-gray-300 w-56 mb-1 text-black py-0.5 text-xs"
                        type="text"
                        name="phone"
          ...
          <div className="pt-5 flex justify-center">
            <label className="text-xs text-black w-55 text-start" htmlFor="">
              To Change Email Address , Please Contact Support
            </label>
          </div>
          <div className="pt-1 flex justify-center">
            <label
              className="text-xs text-black w-55 text-start underline font-medium whitespace-nowrap"
              htmlFor=""
            >
