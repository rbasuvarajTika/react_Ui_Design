...
const Edit_User = () => {
  ...
  const [authType, setAuthType] = useState("Standard");
  ...
  const toggleAuthType = () => {
    const newAuthType = authType === "Standard" ? "SAML" : "Standard";
    setAuthType(newAuthType);

    // Update userType in userData
    setUserData((prevUserData) => ({
      ...prevUserData,
      authType: newAuthType,
      userType: newAuthType,
    }));
  };
  ...
  const updateUser = async () => {
    ...
    if (editValidation) {
      try {
        ...
        const userDataWithAuthType = {
          ...userData,
          authType: authType,
        };
        console.log("userDataWithAuthType:", userDataWithAuthType);
        const response = await axiosBaseURL.put(
          `/api/v1/users/update/user/${userId}`,
          userDataWithAuthType,
          config
        );
  ...
  return (
    <section className=" max-h-fit  flex justify-center item-center md:px-0 px-4 ">
      <ToastContainer />
      {userData ? (
        <div className="bg-[#ffffff] shadow-xl border rounded-3xl max-w-fit max-w-[800px] md:max-h-[450px]  w-full h-full  mt-5 md:mt-10 overflow-hidden overflow-y-auto pb-5 no-scrollbar ">
          <div className="pt-5 flex justify-center">
            <div className=" border  h-5 rounded-xl w-40 relative">
              <div
                className="bg-orange-500 w-20 h-6 rounded-xl flex justify-center cursor-pointer items-center absolute -top-[3px] text-xs"
              ...
              <p
                className="text-gray-400 absolute right-7 flex justify-center items-center text-xs cursor-pointer"
                onClick={toggleAuthType}
              >
                {authType === "Standard" ? "SAML" : "Standard"}
              </p>
            </div>
          </div>

          <form className="">
            <div className=" flex  flex-col xl:items-start md:items-start items-center">
              <div className="px-5 pt-10">
                <div className="flex w-full xl:flex-row md:flex-row flex-col  xl:gap-5 md:gap-5 gap-1 justify-between ">
                  <div className="flex flex-col">
                    <div className=" flex items-center flex-row w-full g ">
                      <div className=" flex  justify-start  flex-col w-full ">
                        ...
                        <input
                          className="gap-1 bg-[#919194] rounded-2xl border border-gray-300 w-56  text-black py-0.5 text-xs t-1"
                          name="userName"
                          type="text"
                  ...
                  <div className="flex flex-col">
                    <div className=" flex items-center flex-row w-full g ">
                      <div className=" flex  justify-start  flex-col w-full ">
                        ...
                        <input
                          className="bg-[#f2f2f2] rounded-2xl border border-gray-300 w-56 text-black py-0.5 text-xs"
                          type="text"
                          name="firstName"
              ...
              <div className="px-5 pt-10">
                <div className="flex w-full md:flex-row xl:flex-row flex-col  xl:gap-5 md:gap-5 gap-1 justify-between ">
                  <div className="flex flex-col">
                    <div className=" flex items-center flex-row w-full g ">
                      <div className=" flex  justify-start  flex-col w-full ">
                        <label
                ...
                <div className="flex w-full md:flex-row xl:flex-row flex-col md:gap-5 xl:gap-5 gap-1 justify-between ">
                  <div className="flex flex-col">
                    <div className=" flex items-center flex-row w-full g ">
                      <div className=" flex  justify-start  flex-col w-full ">
                        <label
                          className="text-xs text-black w- text-start"
                          htmlFor=""
                        >
                          Enter New Password:
                        </label>
        ...
        <div className="bg-[#ffffff] max-w-[100px] max-h-[1000px] w-full h-full  mt-5 overflow-hidden overflow-y-scroll pb-5 no-scrollbar">
          <div role="status center">
            <svg
              aria-hidden="true"
              class="w-25 h-20 mr-20 text-gray-200 text-center animate-spin dark:text-gray-600 fill-blue-600"
              viewBox="0 0 100 101"
              fill="none"
