...
function Login() {
  ...
  return (
    <div className=" bg-[#1B4A68] w-screen h-screen flex items-center justify-center relative z-20 ">
      <h1 className="absolute top-6 left-4 sm:top-8 sm:left-1 text-lg text-white flex z-20">
        Tika{" "}
      ...
      <h1 className="absolute right-4 top-20 top-[1.5rem] md:top-8 text-white text-3xl  z-20 ">
        AB
      ...
      <div className="border-style absolute bg-orange-400 sm:left-10 sm:top-8 w-10 h-10 z-10 left-4 top-4 md:w-12 md:h-12"></div>
      <div className="bg-[rgb(43,108,142)] border-[#235979]  border-[10px]  rounded-3xl flex flex-col items-center p-5 sm:p-8 md:p-10 z-[999] w-11/12 max-w-sm lg:max-w-md">
