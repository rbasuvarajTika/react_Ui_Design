    ...
    <div className="fixed top-10 lg:left-48 left-0 right-0 z-50  w-full p-4 overflow-x-hidden overflow-y-auto ">
      ...
      <div className="relative  bg-[#ffffff] rounded-2xl shadow-md shadow-gray-300  h-[calc(100vh-5rem)] w-full max-w-2xl md:pt-6 pb-10 py-3 md:pl-10 pl-5 md:pr-14 pr-10 mt-53">
        ...
        <div style={{ position: 'relative', marginTop: '10px' }}>
          <input
            className='bg-[#f2f2f2] rounded-2xl border border-gray-300 xl:w-[120px] text-black py-0.5 text-xs t-1'
            type="text"
            name="from"
            value={fromPage}
          ...
          <input
            ...
            placeholder="To Page"
          />
          <div style={{ position: 'absolute', top: '0', right: '240px' }}>
            <div className='sm:w-20 csm:w-32 vsm:w-20 w-18 bg-[#00ab06] rounded-xl flex justify-center md:text-sm text-xs cursor-pointer'>
              Save
            </div>
          </div>
        </div>
