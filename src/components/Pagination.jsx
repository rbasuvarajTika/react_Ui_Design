  ...
  return (
    <>
      <div className="flex gap-4 justify-end ml-auto">
        ...
        <p className="text-black text-base  flex flex-wrap flex-shrink-0 justify-center items-center">
          {currentPage} - {npage}
        </p>

        <div
          className={`border cursor-pointer w-7 h-7 rounded-xl text-black ${
            currentPage !== npage ? "text-[#a8a8a8]" : ""
